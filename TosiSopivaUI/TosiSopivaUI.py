...
class Application(tk.Tk):
    ...
    def update_customer(self, customer_id, customer_firstName, customer_lastName, customer_address, customer_zip, customer_city, customer_phone, customer_email):
        engine = self.engine
        engine.updateCustomer(customer_id, customer_firstName, customer_lastName, customer_address, customer_zip, customer_city, customer_phone, customer_email)
